...
<div class="max-w-4xl">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Редактировать услугу</h1>
        <p class="text-gray-600 mt-1">Обновите детали услуги</p>
    </div>
    ...
    <form method="POST" action="{{ route('manager.services.update', $service->id) }}" class="bg-white rounded-2xl border border-gray-200 p-8">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-lg outline-none transition-colors focus:border-[#319885]" 
                            placeholder="5"
                            value="{{ old('duration_min_days', $service->duration_min_days) }}"
                            min="0"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-lg outline-none transition-colors focus:border-[#319885]" 
                            placeholder="14"
                            value="{{ old('duration_max_days', $service->duration_max_days) }}"
                            min="0"
                        >
                    </div>
                </div>
