...
<div class="max-w-4xl">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Создать новую вакансию</h1>
        <p class="text-gray-600 mt-1">Заполните детали для создания вакансии</p>
    </div>
    ...
    <form method="POST" action="{{ route('manager.vacancies.store') }}" class="bg-white rounded-2xl border border-gray-200 p-8">
        @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Полная занятость" {{ old('employment_type') == 'Полная занятость' ? 'selected' : '' }}>Полная занятость</option>
                        <option value="Частичная занятость" {{ old('employment_type') == 'Частичная занятость' ? 'selected' : '' }}>Частичная занятость</option>
                        <option value="Контракт" {{ old('employment_type') == 'Контракт' ? 'selected' : '' }}>Контракт</option>
                        <option value="Стажировка" {{ old('employment_type') == 'Стажировка' ? 'selected' : '' }}>Стажировка</option>
                        <option value="Удаленная работа" {{ old('employment_type') == 'Удаленная работа' ? 'selected' : '' }}>Удаленная работа</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="KZT" {{ old('currency') == 'KZT' ? 'selected' : '' }}>KZT</option>
